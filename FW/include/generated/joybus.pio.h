...
// Joybus program uses one state machine per port (up to four),
// on consecutive pins starting at pin
static inline void joybus_program_init(PIO pio, uint offset, uint pin, uint count, pio_sm_config *configs) {
    // Must run 12800000hz
